...
- No dedicated admin screen for browsing replacement credits or teacher invites directly (only via My Account / session-level views).
- Minor "sessions below minimum" dashboard stat card (mentioned as a nice-to-have early on) was not built.
